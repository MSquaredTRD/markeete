  ...
  return (
    <main>
      ...
      <footer className="site-footer">
        ...
        <div className="footer-column"><strong>Protocol</strong><a href={VERIFIED_CONTRACT_URL} target="_blank" rel="noreferrer">Verified escrow</a><a href={METADATA_REGISTRY_URL} target="_blank" rel="noreferrer">Metadata registry</a><a href={SOURCIFY_METADATA_REGISTRY_URL} target="_blank" rel="noreferrer">Registry exact match</a><a href="/abi/DeliveryEscrow.json" target="_blank" rel="noreferrer">Escrow ABI</a><a href="/abi/ProductMetadataRegistry.json" target="_blank" rel="noreferrer">Registry ABI</a><code>{ESCROW_ADDRESS}</code><code>{METADATA_REGISTRY_ADDRESS}</code></div>

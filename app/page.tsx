...
const TABS = ['Market', 'Orders', 'List product', 'Funds', 'Protocol'] as const;
...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer><span>markeete.online</span><span>Base · USDC · no backend</span><a href={`${BASESCAN_URL}/address/${ESCROW_ADDRESS}`} target="_blank" rel="noreferrer">Verify contract</a></footer>
    </main>
  );
}
